...
from api.views import list_term_mentions, list_property_term, list_property_objects, list_class_individuals, list_all_individuals, paper_details, list_details, list_authors, list_classes_with_individuals

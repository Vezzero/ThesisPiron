...
from api.views import list_term_mentions, list_property_term, list_property_objects, list_class_individuals, list_all_individuals, paper_details, list_all_annotators
...
urlpatterns = [
    ...
    path("api/list_all_annotators/", list_all_annotators),
